...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        if (($res = parent::beforeSave($insert)) && $this->isNewRecord) {
    ...
    {
        Yii::$app->getAuthManager()->revokeAll($this->id); // Если у пользователя нет ролей вернет false.
    ...
    public function behaviors()
    {
        return [
            ...
            // replacing password to password_hash
            'replacePasswordToHash' => [
